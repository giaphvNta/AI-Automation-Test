...
3. Sau khi đủ tham số, đọc **TOÀN BỘ** `{{APP_ROOT}}/skills/ai-test/SKILL.md` (1 Read), rồi đọc `{{APP_ROOT}}/skills/ai-test/rules/RULES.md`, xuất self-check, và thực thi đúng pipeline 4 pha nội bộ.
